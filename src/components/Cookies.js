...
function Cookies() {
  return (
	  ...
	  <div className="cookies">
	   <p  style={{ fontSize: "20px",margin:"0px 15px 0px 15px",paddingTop:"70px" }}>
...
di postfolio.item in riferimento al trattamento dei dati degli utenti di
postfolio.it.<br></br>
...
che interagiscono con postfolio.it ed è raggiungibile all'indirizzo
corrispondente alla pagina iniziale:
www.postfolio.it<br></br>
3. L'informativa è resa solo per postfolio.it e non anche per altri
...
momento della connessione alle pagine web di postfolio.it,
indipendentemente dagli scopi del collegamento stesso, secondo la legislazione
Italiana ed Europea.<br></br>
...
e i mezzi del trattamento di dati personali. Si occupa anche dei profili sulla sicurezza.<br></br>

2. Relativamente al presente sito web il titolare del trattamento è: Dario Vettura , e per ogni chiarimento o esercizio dei diritti dell'utente potrà contattarlo al
seguente indirizzo mail: d.vettura.wd@gmail.com<br></br>
...
del dati, il responsabile del trattamento dei dati del sito drinkinstreet è: andrea
vettura.
3 - Luogo trattamento dati
1. Il trattamento dei dati generato dall'utilizzo di postfolio.it avviene
presso waltostrasse 13, Germania
...
III - COOKIES<br></br>
1 - Tipo di Cookies
1. Il sito drinkinstreet utilizza cookies per rendere l'esperienza di navigazione
...
comportamento degli utenti su drinkinstreet. La rilevazione avviene in forma
...
2. Il sito drinkinstreet intende pertanto informare l'utente sull'esistenza dei diritti
...
Personali, o inviando una mail all'indirizzo: gio.fenderico@flanagansnapoli.com
...
previste dall'articolo 45 e ss, del Regolamento (UE).<br></br>
VII. SICUREZZA DATI FORNITI<br></br>
